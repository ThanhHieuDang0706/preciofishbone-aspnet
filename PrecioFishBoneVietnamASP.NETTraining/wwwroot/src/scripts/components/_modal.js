...
const addSubmitFormEvent = (state) => {
    $('#modal-ok-button').on('click', () => {
        ...
        if (action === 'create') {
            if (type === 'folder') {
                ...
                const modifiedBy = $('#modifiedBy').val();
